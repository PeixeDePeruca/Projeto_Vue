    ...
    return {
      ...
      database: [
        { 
          ...
          type: 'eva', 
          name: 'EVA-01', 
          designation: 'Protótipo de Testes', 
          description: 'Unidade pilotada por Shinji Ikari. Contém a alma de Yui Ikari.',
          imageName: 'eva01.webp'
        },
        { 
          id: 2, 
          type: 'eva', 
          name: 'EVA-00', 
          designation: 'Protótipo Inicial', 
          description: 'Primeira unidade funcional, pilotada por Rei Ayanami.',
          imageName: 'eva00.webp'
        },
        { 
          id: 3, 
          type: 'eva', 
        ...
        { 
          ...
          name: 'Sachiel', 
          designation: '3º Anjo', 
          description: 'Primeiro Anjo a atacar Neo Tokyo-3 após 15 anos de hiato.',
          imageName: 'sachiel.webp'
        },
        { 
          id: 5, 
          type: 'anjo', 
          name: 'Ramiel', 
          designation: '5º Anjo', 
          description: 'Fortaleza voadora com formato octaédrico e broca de alta perfuração.',
          imageName: 'ramiel.webp'
        },
        { 
          id: 6, 
          type: 'anjo', 
          name: 'Zeruel', 
          designation: '14º Anjo', 
          description: 'Entidade de combate físico devastador com braços em formato de lâminas.',
          imageName: 'zeruel.webp'
        }
      ]
    };
  },
